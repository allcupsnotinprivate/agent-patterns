...
- **[LLMCompiler](../llm-compiler/)** - планировщик стримит DAG задач, а исполнитель запускает их параллельно по мере готовности зависимостей (ускорение вместо только экономии).
